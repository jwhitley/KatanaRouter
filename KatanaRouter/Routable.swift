...
public protocol Routable {
  ...
  func change<Store>(store: Store,
                     destinationsToPop: [Destination],
  ...
  ///   - completionHandler: completion handler **needs to be called** after the transition
  func changeActiveDestination<Store>(store: Store,
                                      currentActiveDestination: Destination,
...
public extension Routable {
  ...
  func push<Store>(store: Store, destination: Destination, completionHandler: @escaping RoutableCompletion) -> Routable {
